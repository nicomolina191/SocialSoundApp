...
export default function Landing() {
    return (
        <Grid container direction="column" className={style.landing} spacing={5}>
            <Grid item container className={style.navbar} xs={12} justifyContent="space-between">
                <Grid item container xs={5} alignItems="center" justifyContent="flex-end" spacing={4}>
                    <Grid item >
                ...
                <Grid item container xs={3} alignItems="center" justifyContent="flex-end" spacing={3} className={style.buttons}>
                    <Grid item>
                        <Link to='/login'>
                            <Button variant="contained" className={style.login}>Login</Button>
                        </Link>
                    </Grid>
                    <Grid item>
                        <Link to='/register'>
                            <Button variant="contained" className={style.signUp}>Sign up</Button>
                        </Link>
                    </Grid>
                </Grid>
            </Grid>
            <Grid item container xs={12} className={style.getStarted}>
                <Grid item container xs={7} direction="column">
                    ...
                    <Grid item container direction="column" alignItems="flex-end" spacing={2}>
                        ...
                        <Grid item className={style.share}>
                            <Link to='/register'>
                                <Button variant="contained" className={style.signUp}>Get Started</Button>
                            </Link>
                        </Grid>
                    </Grid>
                </Grid>
                <Grid item container xs={5} className={style.cardMusic} justifyContent="center" alignItems="center">
                    <Grid item container className={style.card}>
                        <Grid item container className={style.card2} direction="column" alignItems="center">
                            ...
                            <Grid item container direction="column" alignItems="center">
                                ...
                                <Grid item>
                                    <Typography variant='caption' className={`${style.text} ${style.author}`}>
                                        Jonh Doe
                                    </Typography>
                                </Grid>
                                ...
                                <Grid item container justifyContent="space-between" className={style.timers}>
                                    <Grid item>
                                        <Typography variant='caption' className={`${style.text} ${style.time}`}>
                                            1:21
                                        </Typography>
                                    </Grid>
                                    <Grid item>
                                ...
                                <Grid item container justifyContent="space-between" alignItems="center" className={style.mediaPlayer}>
                                    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="-190 0 512 512" className={style.otherMediaPlayers}>
                                        <path d="M267.5 440.6c9.5 7.9 22.8 9.7 34.1 4.4s18.4-16.6 18.4-29V96c0-12.4-7.2-23.7-18.4-29s-24.5-3.6-34.1 4.4l-192 160L64 241V96c0-17.7-14.3-32-32-32S0 78.3 0 96V416c0 17.7 14.3 32 32 32s32-14.3 32-32V271l11.5 9.6 192 160z" />
                                    </SvgIcon>
                                    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className={style.otherMediaPlayers}>
                                        <path d="M459.5 440.6c9.5 7.9 22.8 9.7 34.1 4.4s18.4-16.6 18.4-29V96c0-12.4-7.2-23.7-18.4-29s-24.5-3.6-34.1 4.4L288 214.3V256v41.7L459.5 440.6zM256 352V256 128 96c0-12.4-7.2-23.7-18.4-29s-24.5-3.6-34.1 4.4l-192 160C4.2 237.5 0 246.5 0 256s4.2 18.5 11.5 24.6l192 160c9.5 7.9 22.8 9.7 34.1 4.4s18.4-16.6 18.4-29V352z" />
                                    </SvgIcon>
                                    <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className={style.play}>
            ...
            <Grid item container className={style.features} xs={12} m={`1%`} spacing={1} id='features'>
                <Grid item ml={`2%`}>
            ...
            <Grid item container className={style.features} xs={12} m={`1%`} spacing={1} id='premium'>
                <Grid item ml={`2%`}>
                    <Typography variant='h4' className={style.text}>
                        Premium Features
                    </Typography>
            ...
            <Grid item container xs={12} className={style.footer} direction="column" alignItems="center" mt={`20%`}>
                ...
                <Grid item>
                    <a href="https://github.com/agustinagomez/FinalProject/tree/master">
                        <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className={style.footerGitHub}>
